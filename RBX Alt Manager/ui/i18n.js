...
const RU = {
  ...
  // ---------------------------------------------------------------- operational screens
  'Live account, client and automation status': 'Состояние аккаунтов, клиентов и автоматизации',
  'Accounts': 'Аккаунты',
  'Clients': 'Клиенты',
  ...
  'One supervisor and one retry budget for crash, stuck and Nexus recovery':
    'Один супервизор и единый бюджет повторов для сбоев, зависаний и Nexus',
  'Automatic recovery': 'Автоматическое восстановление',
  'Enabled': 'Включено',
  'Relaunch after a crash': 'Перезапуск после сбоя',
  'Relaunch stuck clients': 'Перезапуск зависших клиентов',
  'Cooldown (seconds)': 'Пауза (секунды)',
  'Maximum per hour': 'Максимум в час',
  'Give up after failures': 'Остановиться после ошибок',
  'Inspect client logs and clean dead processes without guessing from window titles':
    'Проверка логов клиентов и очистка мёртвых процессов без догадок по заголовкам окон',
  'Stuck detector': 'Детектор зависаний',
  'Read client logs': 'Читать логи клиентов',
  'Close refused clients': 'Закрывать отклонённые клиенты',
  'Close clients that never joined': 'Закрывать так и не зашедшие клиенты',
  'Starting grace (seconds)': 'Льготный старт (секунды)',
  'Stuck after (seconds)': 'Считать зависшим через (секунды)',
  'Zombie reaper': 'Чистильщик зомби',
  'Dry run only': 'Только пробный запуск',
  'Grace (seconds)': 'Льготный период (секунды)',
  'Sweep every (seconds)': 'Проверять каждые (секунды)',
  'Live verdicts': 'Текущие вердикты',
  'Sweep now': 'Проверить сейчас',
  'No manual sweep yet.': 'Ручной проверки ещё не было.',
  'Anti-AFK and scheduled bot/player cycles': 'Anti-AFK и расписание циклов ботов/игроков',
  'Anti-AFK': 'Anti-AFK',
  'Interval (seconds)': 'Интервал (секунды)',
  'Key': 'Клавиша',
  'Delay between windows (ms)': 'Пауза между окнами (мс)',
  'Pulse now': 'Отправить сейчас',
  'Botting schedule': 'Расписание боттинга',
  'Start': 'Старт',
  'Hard client limits, Roblox builds, profile cleanup and optional account generation':
    'Жёсткие лимиты клиентов, сборки Roblox, очистка профиля и генератор аккаунтов',
  'Per-client limits': 'Лимиты на клиент',
  'Job Object limits': 'Лимиты Job Object',
  'CPU hard cap % (0 = off)': 'Жёсткий лимит CPU % (0 = выкл.)',
  'Working set MB (0 = off)': 'Working set, МБ (0 = выкл.)',
  'Memory priority': 'Приоритет памяти',
  'Power throttling': 'Энергосбережение',
  'Roblox profile cleanup': 'Очистка профиля Roblox',
  'Run a dry-run before deleting anything.': 'Сначала выполните пробный запуск без удаления.',
  'Dry run': 'Пробный запуск',
  'Clean shown data…': 'Удалить показанные данные…',
  'Roblox versions': 'Версии Roblox',
  'Fallback to live when a pinned build is rejected': 'Перейти на live, если закреплённая сборка отклонена',
  'Refresh catalog': 'Обновить каталог',
  'Use standard auto-updating Roblox': 'Использовать обычный автообновляемый Roblox',
  'BloxGen (optional paid provider)': 'BloxGen (необязательный платный сервис)',
  'Enable provider': 'Включить сервис',
  'Balance': 'Баланс',
  'Generate': 'Создать',
  'The provider key stays in memory only.': 'Ключ сервиса остаётся только в памяти.'
};
