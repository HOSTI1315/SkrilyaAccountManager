...
const RU = {
  ...
  'Launching {name} on Android…': 'Запускаю {name} на Android…',
  '{name}: joined on Android': '{name}: вошёл в игру на Android',
  'Launch on Android supports one account at a time for now': 'Пока запуск на Android работает с одним аккаунтом за раз',
  'Android emulator serial (auto = first ready)': 'Серийный номер Android-эмулятора (auto = первый готовый)',
  'Android launch returned no result': 'Android-запуск не вернул результат',
  'Android launch did not resolve': 'Не удалось определить результат Android-запуска',
  'Set a place id in the launcher first': 'Сначала укажите Place ID в панели запуска',
  ...
  'Launch on Android…': 'Запустить на Android…',
