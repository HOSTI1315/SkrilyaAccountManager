...
namespace RBX_Alt_Manager.Forms
{
    public partial class ThemeEditor : Form
    {
        ...
        /// <summary>
        /// ColorTranslator.FromHtml throws on anything malformed, and this runs during startup — one bad value
        /// hand-edited into RAMTheme.ini took the whole app down before it drew a window. Fall back instead.
        /// </summary>
        ...
        public static void LoadTheme()
        {
            ...
            if (Theme.Exists("LabelsBC")) LabelBackground = TryHtmlColor(Theme.Get("LabelsBC"), LabelBackground); else LabelBackground = TextBoxesBackground;
            if (Theme.Exists("LabelsFC")) LabelForeground = TryHtmlColor(Theme.Get("LabelsFC"), LabelForeground); else LabelForeground = TextBoxesForeground;
        ...
        private void ToggleDarkTopBar_Click(object sender, EventArgs e)
        {
            ...
            SaveTheme();
            MessageBox.Show("This option requires SkrilyaAccountManager to be restarted.\nThis may not work on older versions of windows.\nEnabled: " + (UseDarkTopBar ? "True" : "false"), "SkrilyaAccountManager", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}