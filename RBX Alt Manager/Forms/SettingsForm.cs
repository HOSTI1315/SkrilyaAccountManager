...
namespace RBX_Alt_Manager.Forms
{
    public partial class SettingsForm : Form
    {
        ...
        public SettingsForm()
        {
            ...
            BuildClientsTab(); // before Rescale, so the runtime-built tab scales with the designer-built ones
        ...
        private void MultiRobloxCB_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (!AccountManager.Instance.UpdateMultiRoblox())
                MessageBox.Show("Roblox is currently running, multi roblox will not work if roblox is open.", "SkrilyaAccountManager", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
        ...
        private void EnableWSCB_CheckedChanged(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("SkrilyaAccountManager must be restarted to enable this setting", "SkrilyaAccountManager", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void AllowExternalConnectionsCB_CheckedChanged(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("SkrilyaAccountManager must be restarted to enable this setting\n\nThis setting requires admin privileges", "SkrilyaAccountManager", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
