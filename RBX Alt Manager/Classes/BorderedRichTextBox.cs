    ...
    public class BorderedRichTextBox : RichTextBox // https://github.com/r-aghaei/TextBoxBorderColor/blob/master/src/TextBoxBorderColor/MyTextBox.cs
    {
        ...
        public Color BorderColor
        {
            ...
            set
            {
                ...
                // See BorderedTextBox: this setter runs on every theme change and leaked two GDI Pen handles
                // (plus an undisposed SolidBrush) each time.
                opaquePen?.Dispose();
                borderPen?.Dispose();

                opaquePen = new Pen(Color.FromArgb(255, value.R, value.G, value.B));
