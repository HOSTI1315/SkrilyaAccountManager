...
namespace RBX_Alt_Manager.Forms
{
    partial class AccountControl
    {
        ...
        '\''};
            ...
            // ServiceColors was a BinaryFormatter blob in the .resx; BinaryFormatter is gone in .NET 9+ and
            // WinForms' replacement deserializer only handles a fixed set of types, not FCTB's. The blob held
            // the control's default colors anyway, so we simply let FastColoredTextBox use its own defaults.
    ...
    "";
        ...
        '\''};
            ...
            // see the ServiceColors note on ScriptBox above
